...
let fakeDate = [
  {
    open: { name: "7C", img_id: "trefle_7", index: 6 },
    closed: { name: "JC", img_id: "trefle_v", index: 10 },
  },
  {
    open: { name: "7D", img_id: "carreau_7", index: 6 },
    closed: { name: "8D", img_id: "carreau_8", index: 7 },
  },
  {
    open: { name: "QH", img_id: "coeur_d", index: 11 },
    closed: null,
  },
  {
    open: { name: "QC", img_id: "trefle_d", index: 11 },
    closed: { name: "KC", img_id: "trefle_r", index: 12 },
  },
  {
    open: { name: "6H", img_id: "coeur_6", index: 5 },
    closed: null,
  },
];
const length = 8;
module.exports = { playCards, cardsList, fakeDate, length };
